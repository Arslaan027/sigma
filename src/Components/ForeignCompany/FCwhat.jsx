...
import FC from "../../assets/Image/FC.jpg"; // Ensure the path to the image is correct
    ...
    <div className="flex justify-center items-center bg-white dark:bg-neutral-800">
      <div className="dark:bg-neutral-900 p-8 mx-auto max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <p>
              A Foreign Company refers to a business entity that is incorporated
              outside India but has a presence in India, either through a
              branch, office, or subsidiary. These companies must comply with
              Indian laws and regulations, particularly those relating to
