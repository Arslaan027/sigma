...
import LLP from "../../../assets/Image/LLPwhat.jpg"; // Ensure the path to the image is correct
    ...
    <div className="flex justify-center items-center bg-white dark:bg-neutral-800">
      <div className="dark:bg-neutral-900 p-8 mx-auto max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <p>
              A Limited Liability Partnership (LLP) is a hybrid structure that
              blends elements of both partnerships and corporations. In this
              structure, partners enjoy limited liability, meaning their
              personal assets are not at risk if the business incurs debts.
              However, it retains the flexible partnership management style,
              allowing partners to define their roles and responsibilities. It
              is ideal for professionals or business partners seeking a formal
              structure with reduced liability exposure.
            </p>
          </motion.div>
