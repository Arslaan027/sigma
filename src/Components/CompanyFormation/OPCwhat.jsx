...
import OPC from "../../assets/Image/OPCwhat.jpg"; // Ensure the path to the image is correct
    ...
    <div className="flex justify-center items-center bg-white dark:bg-neutral-800">
      <div className="dark:bg-neutral-900 p-8 mx-auto max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <p>
              The One Person Company (OPC) is a relatively new structure in
              India, designed for sole entrepreneurs. It allows a single
              individual to own and operate a company while enjoying the
              benefits of limited liability. The company is treated as a
              separate legal entity, protecting the personal assets of the
              individual. This model is intended to encourage sole
              proprietorships to formalize into a company structure, while
