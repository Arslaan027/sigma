...
import CS from "../../../assets/Image/CSS2.jpg";
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <p>
              ...
              united voluntarily to meet common economic, social, and cultural
              needs. Cooperative societies operate democratically with the aim
              of mutual benefit. Members work together to support each other in
              achieving shared objectives, often providing services or goods to
