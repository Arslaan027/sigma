...
import why from "../../assets/Image/IBwhy.jpg"; // Import the image or component for the visual
    ...
    <div className="flex justify-center items-center bg-white dark:bg-neutral-800">
      <div className="dark:bg-neutral-900 p-8 mx-auto max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <p>
              Sigma Solutions provides comprehensive guidance for Startup India
              Registration, ensuring that your business is well-prepared to meet
              all the necessary criteria. We assist with documentation,
              application filing, compliance, and post-registration benefits,
