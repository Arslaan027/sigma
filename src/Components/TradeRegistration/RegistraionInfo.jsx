  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">
        <span className="text-red-500">Trade License</span> Registration
      </h1>

      {/* Overview Section */}
      <div className="bg-gradient-to-r from-white via-gray-100 to-white p-8 rounded-lg shadow-lg mb-12">
            ...
            <ul className="space-y-4 text-gray-800">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <span className="text-gray-700">Urban Local Body</span>
                </div>
              </li>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <strong className="block font-semibold">Stage:</strong>
                  <span className="text-gray-700">Pre-Operation</span>
                </div>
              </li>
          ...
          <div className="flex-1 md:pl-4">
            <ul className="space-y-4 text-gray-800">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <strong className="block font-semibold">Fee:</strong>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="relative border-l border-gray-200 ml-1">
          {[
            ...
            "Fill the form, select license type, validity, upload required documents, and submit the application.",
            ...
            >
              <div className="absolute w-3 h-3 bg-red-500 rounded-full mt-1.5 -left-3.5 border border-white"></div>
