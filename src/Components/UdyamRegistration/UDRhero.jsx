...
import UDR from "../../assets/Image/UDRhero.jpg"; // Ensure the image path is correct
...
const UDRhero = () => {
  ...
  return (
    ...
    >
      ...
      >
        Simplify Your Business Registration with Udyam!
      </motion.p>
      <motion.button
        onClick={openModal}
